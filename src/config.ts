...
/**
 * True for the NotebookLM / Gemini Notebook app hosts.
 *
 * Google's rebrand moved the app to notebook.google.com; notebooklm.google.com
 * still redirects there. Parsed rather than substring-matched so lookalikes
 * such as notebook.google.com.evil.test are rejected.
 */
